...
const references: MediaReference[] = [
  {
    slug: 'cadena-ser-hoy-por-hoy-vivienda-premium-madrid',
    title: 'En directo en Hoy por Hoy: la venta de vivienda premium en Madrid',
    source: 'Cadena SER',
    type: 'radio',
  ...
  {
    slug: 'escritura-publica-vivienda-alquiler-protegerse',
    title: 'La vivienda en alquiler: cómo protegerse',
    source: 'Escritura Pública · Consejo General del Notariado',
    type: 'article',
    href: 'https://escriturapublica.es/la-vivienda-en-alquiler-como-protegerse/',
    publishedAt: '2026-07-01',
    excerpt: 'Reportaje del Consejo General del Notariado sobre seguridad jurídica en el arrendamiento, con el análisis de José María Alfaro sobre la caída de la oferta disponible.',
    tags: ['alquiler', 'arrendadores', 'inquilinos', 'legislación'],
    featured: true,
  },
  {
    slug: 'precios-fuerzan-negociacion-plazos',
    title: 'Los altos precios de la vivienda fuerzan la negociación y alargan los plazos de venta',
    source: 'idealista/news',
    type: 'press',
    href: 'https://www.idealista.com/news/inmobiliario/vivienda/2026/07/15/906315-inmobiliarias-senalan-que-los-altos-precios-de-las-viviendas-fuerzan-la-negociacion',
    publishedAt: '2026-07-15',
    excerpt: 'Lectura de mercado sobre la resistencia del comprador al precio de salida y la ampliación de los plazos de cierre en las operaciones.',
    tags: ['compraventa', 'compradores', 'vendedores', 'mercado'],
    featured: false,
  },
  {
    slug: 'cope-desaceleracion-ventas-stock',
    title: 'Con la desaceleración de las ventas el stock tenderá a crecer',
    source: 'COPE',
    type: 'radio',
    href: 'https://www.cope.es/actualidad/economia/noticias/jose-maria-alfaro-experto-inmobiliario-2026-desaceleracion-ventas-casas-stock-tendera-crecer-hay-analizar-oferta-aprovechar-comprar-mejor-precio-20251213_3265952.html',
    publishedAt: '2025-12-13',
    excerpt: 'Análisis sobre el cambio de ciclo en la compraventa y el margen de negociación que abre para quien sabe leer la oferta disponible.',
    tags: ['compraventa', 'compradores', 'mercado', 'inversión'],
    featured: false,
  },
  {
